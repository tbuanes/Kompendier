...
\end{displaymath}
som faktisk har en enkel løsning $\Big(\theta(t) = A\sin(\sqrt{\frac{g}{\ell}}t) + B\cos(\sqrt{\frac{g}{\ell}}t)\Big)$. Men hvordan kan vi vite at $\sin\theta \simeq \theta$, hvor liten må $\theta$ være for at tilnærmingen skal fungere, og hvor godt fungerer i det hele tatt denne tilnærmingen?
