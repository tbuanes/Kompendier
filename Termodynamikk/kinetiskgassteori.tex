...
\begin{displaymath}
	p = \eta m\langle v_\perp^2 \rangle = \frac{1}{3}nm\langle v^2 \rangle = \frac{2}{3}\eta \left(\frac{1}{2}m\langle v^2 \rangle\right).
\end{displaymath}
