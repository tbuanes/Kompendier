...
$e$ som brukes når vi skriver det komplekse tallet på eksponentialform er Eulars tall som er kjent fra eksponentialfunksjoner med reelle tall. Det at $e$ nå opphøyes i en imaginær potens har noen interessante konsekvenser som vi kommert tilbake til ganske snart.
...
\begin{texample}
	...
	\begin{displaymath}
		z_1 + z_4 = \ans{2 e^{i\frac{\pi}{3}} + 3e^{i\frac{\pi}{2}}}.
	\end{displaymath}
\end{texample}
